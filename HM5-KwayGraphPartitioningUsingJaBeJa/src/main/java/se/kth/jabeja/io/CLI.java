...
public class CLI {
  ...
  @Option(name = "-model", usage = "Model Selection (between 1 and 3)")
  private int MODEL = 1;

  @Option(name = "-restart", usage = "Restart annealing")
  private int RESTART = 1000;

  @Option(name = "-coefrestart", usage = "Decrease delta T by coef while restarting")
  private float COEFRESTART = 1;
