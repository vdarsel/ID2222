...
public class Config {
  ...
  public Config setModel(Integer model) {
    this.Model = model;
    return this;
  }

  public Config setRestart(Integer restart) {
    this.Restart = restart;
    return this;
  }

  public Config setCoefRestart(Float coefrestart) {
    this.CoefRestart = coefrestart;
    return this;
  }
  ...
  public Float getCoefRestart() {
    if (CoefRestart == null) {
      throw new NullPointerException("CoefRestart is not set");
    }
    return CoefRestart;
  }
  ...
  public Integer getRestart() {
    if (Restart == null) {
      throw new NullPointerException("Restart is not set");
    }
    return Restart;
  }
